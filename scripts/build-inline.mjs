...
for (const [name, marker] of [['status-ui.js','STATUS UI'], ['stage-ui.js','STAGE UI'], ['loupe-ui.js','LOUPE UI'], ['planner-ui.js','PLANNER UI'], ['recognition-ui.js','RECOGNITION UI'], ['guidance-ui.js','GUIDANCE UI']]) {
