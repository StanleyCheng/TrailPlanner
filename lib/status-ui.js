    ...
    // END STATUS STATE
    const statusModel = { banner: null, find: null, route: null, notice: null, step: '', draft: null };
    let statusTickerTimer = 0, statusSublineVisible = false;
    function statusRender() {
      ...
      const showSubline = !!statusModel.find;
